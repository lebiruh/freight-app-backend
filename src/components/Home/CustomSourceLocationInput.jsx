...
const CustomSourceLocationInput = ({placeholder, onSelect, setOrder}) => {
              ...
              suggestions.map((place) => (
                <li
                  ...
                  onClick={() => {
                    ...
                    setOrder((prevState) => ({ ...prevState, source: place.display_name }));
                    setOrder((prevState) => ({ ...prevState, sourceLat: parseFloat(place.lat) }));
                    setOrder((prevState) => ({ ...prevState, sourceLon: parseFloat(place.lon) }));
                    setSuggestions([])
                  }}
                  style={{
                    padding: "6px",
...
export default CustomSourceLocationInput