      ...
      <div className="w-full py-6 px-5">
        <div className="w-full flex flex-wrap gap-5 justify-center items-center">
          <div className="w-full md:w-1/3 place-items-center">
            <h5 className="text-white mb-4 font-bold text-3xl">Get In Touch</h5>
          ...
          <div className="w-full md:w-1/3 flex-col place-items-center">
            <h5 className="text-white mb-2 font-bold text-3xl">Quick Links</h5>
            <a className="block text-gray-400 p-2 hover:underline" href="/about">About</a>
            <a className="block text-gray-400 p-2 hover:underline" href="/contact">Contact Us</a>
